...
EXPECTED = [
    ...
    "certificates/groupoid_motivic_interface_checks.py",
    ...
    "chapters/03_arithmetic_groupoids_and_toric_period_morphisms.tex",
    "main.tex",
    "provenance.json",
    "validate_package.py",
]
...
assert reloaded["output_pdf"]["bytes"] == output_path.stat().st_size
assert reloaded["output_pdf"]["sha256"] == digest(output_path)
print(
    json.dumps(
        {
            "status": "PASS",
